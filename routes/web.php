...
Route::group(['prefix' => 'betters'], function () {
    ...
    Route::post('uploadPhoto/{better}', [BetterController::class, 'uploadPhoto'])->name('better.uploadPhoto');
});
Route::group(['prefix' => 'horses'], function () {
    ...
    Route::post('uploadPhoto/{horse}', [HorseController::class, 'uploadPhoto'])->name('horse.uploadPhoto');
});
